                        ...
                        <div class="panel-content">
                            <?php foreach ($items as $item): ?>
                                ...
                                <div class="progress progress-sm mb-3">
                                    <div class="progress-bar <?=$item['class'];?>" role="progressbar" style="width: <?=$item['width'];?>;" aria-valuenow="<?=$item['value_now'];?>" aria-valuemin="<?=$item['value_min'];?>" aria-valuemax="<?=$item['value_max'];?>"></div>
                                </div>
                            <?php endforeach; ?>
                        </div>
                    </div>
